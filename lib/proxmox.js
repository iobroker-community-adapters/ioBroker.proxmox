...
class ProxmoxUtils {
    ...
    async getNodes() {
        ...
        try {
            ...
            throw new Error('Invalid data received in Nodes');
        }
    }
    ...
    async getNodeStatus(node, useCache) {
        ...
        try {
            ...
            throw new Error('Invalid data received NodeStatus');
        }
    }
    ...
    async getNodeDisks(node, useCache) {
        ...
        try {
            ...
            throw new Error('Invalid data received in NodeDisks');
        }
    }
    ...
    async _getData(url, method, data = null, retry = false, additional = null) {
        ...
        try {
            ...
            if (additional !== 'storage') {
                if (additional !== 'disk' && additional !== 'resource') {
                    // kann sein dass die platte aus ist dann ignoriere es und schmeisse nur error message
